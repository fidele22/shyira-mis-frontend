  ...
  return (
    <div className="navigation">
      ...
      <ul>
        ...
        <li onClick={() => toggleDropdown('order')} className="dropdown">
        <FaClipboardList /> Logistic requisition
          {dropdownsOpen.order && (
            <ul className="dropdown-menu">
                     <li onClick={() => setCurrentPage('approved-logistic-order')}> <FaList /> View Approved order</li>
                     <li onClick={() => setCurrentPage('recieved-logistic-order')}> <FaList /> View Recieved order</li>
                     <li onClick={() => setCurrentPage('rejected-logistic-order')}> <FaList /> View Rejected order</li>
